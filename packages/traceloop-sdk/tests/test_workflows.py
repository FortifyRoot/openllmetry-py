...
def test_simple_workflow(exporter, openai_client):
    ...
    assert open_ai_span.attributes.get("fortifyroot.prompt.template") == "Tell me a {what} about {subject}"
    assert open_ai_span.attributes.get("fortifyroot.prompt.template_variables.what") == "joke"
    assert open_ai_span.attributes.get("fortifyroot.prompt.template_variables.subject") == "OpenTelemetry"
    assert open_ai_span.attributes.get("fortifyroot.prompt.version") == "5"
